#this script loops through all scipy stats distributions and calculates
#the minimum fit between the data and each distribution, returning
#the parameters and distribution
#the code was originally written by 'tmthydvnprt' and taken from stackoverflow
#at this address:
